...
| Arm usage | Native AArch64 workflow on four Neoverse-N2 cores, CPU-only pinned llama.cpp, Arm capability/topology/memory evidence, KleidiAI build integration |
| Reliability | Absolute and baseline-relative quality policy, critical validators, evidence-completeness checks, safe process ownership, privacy scan |
